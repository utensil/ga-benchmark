...
#define GABM_ITERATIONS 1000
#define GABM_REPETITIONS 30

#define GABM_ZERO_TOLERANCE 1.0e-15

#define GABM_CAPTURE(FUNC, SYSTEM_NAME, SYSTEM_VERSION, COMPILER_ID, COMPILER_VERSION, SOLUTION, MODEL, D_DIMENSIONS, CASE) \
    BENCHMARK_CAPTURE(FUNC, SystemName                                                                                      \
                      : SYSTEM_NAME / SystemVersion                                                                         \
                      : SYSTEM_VERSION / CompilerID                                                                         \
                      : COMPILER_ID / CompilerVersion                                                                       \
                      : COMPILER_VERSION / Solution                                                                         \
                      : SOLUTION / Model                                                                                    \
                      : MODEL / D                                                                                           \
                      : D_DIMENSIONS / CASE, "")                                                                            \
...
#define GABM_ASSERT_OPERATION_DEFINITION(GROUP, OPERATION)                                                                                       \
    static_assert(GABM_##GROUP##_##OPERATION##_Defined,                                                                                          \
                  "Use GABM_DEFINE_<GROUP-NAME>[_<OPERATION-NAME>], GABM_REPORT_<OPERATION-GROUP-NAME>_[OPERATION-NAME_]IS_NOT_IMPLEMENTED, or " \
                  "GABM_REPORT_<OPERATION-GROUP-NAME>_[OPERATION-NAME_]LEADS_TO_COMPILATION_ERROR to define the missing operation.");
...
#define GABM_DEFINE_OPERATION(GROUP, OPERATION, CASE, ...)                                                                                  \
    ...
    {                                                                                                                                       \
        ...
        {                                                                                                                                   \
            auto result = GABM_##GROUP##_##OPERATION##_Impl(GABM_##GROUP##_##OPERATION##_RandomArguments[ind]);                             \
    ...
    {                                                                                                                                       \
        state.SkipWithError("OPERATION_LEADS_TO_RUNTIME_ERROR");                                                                            \
                                                                                                                                            ...
                                                                                                                                            \
    GABM_CAPTURE(GABM_##GROUP##_##OPERATION, GABM_SYSTEM_NAME, GABM_SYSTEM_VERSION, GABM_COMPILER_ID, GABM_COMPILER_VERSION, GABM_SOLUTION, \
                 GABM_MODEL, GABM_D_DIMENSIONS, CASE)                                                                                       \
                                                                                                                                            \
    template <typename... Types>                                                                                                            \
