...
set(ORIGINAL_IN_FILE "${CMAKE_CURRENT_LIST_DIR}/SpecializedUnaryOperations.hpg.in")
set(GENERATED_IN_FILE "${Gaalop_OPTIMIZATION_DIR}/SpecializedUnaryOperations.hpg.in")
set(GENERATED_HPG_FILE "${Gaalop_OPTIMIZATION_DIR}/SpecializedUnaryOperations.hpg")
set(GENERATED_HPP_FILE "${Gaalop_OPTIMIZATION_DIR}/SpecializedUnaryOperations.hpp")

include("${CMAKE_CURRENT_LIST_DIR}/SetBasisBlades.cmake")

if(NOT DEFINED BASIS_BLADES_${GRADE})
  message(FATAL_ERROR "The BASIS_BLADES_${GRADE} variable was not defined.")
endif()
set(BASIS_BLADES "${BASIS_BLADES_${GRADE}}")
