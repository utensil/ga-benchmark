...
set(ORIGINAL_IN_FILE "${CMAKE_CURRENT_LIST_DIR}/SpecializedUtils.hpg.in")
set(GENERATED_IN_FILE "${Gaalop_OPTIMIZATION_DIR}/SpecializedUtils.hpg.in")
set(GENERATED_HPG_FILE "${Gaalop_OPTIMIZATION_DIR}/SpecializedUtils.hpg")
set(GENERATED_HPP_FILE "${Gaalop_OPTIMIZATION_DIR}/SpecializedUtils.hpp")

include("${CMAKE_CURRENT_LIST_DIR}/SetBasisBlades.cmake")

if(NOT DEFINED BASIS_BLADES_1)
  message(FATAL_ERROR "The BASIS_BLADES_1 variable was not defined.")
endif()
