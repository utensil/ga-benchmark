...
using algebra_t = algebra<metric<(GABM_D_DIMENSIONS) + 1, 1, 0, true>, gabm::real_t>;
...
using algebra_t = algebra<metric<(GABM_D_DIMENSIONS), 0, 0>, gabm::real_t>;

#elif GABM_CHECK_MODEL(HomogeneousModel)

using algebra_t = algebra<metric<(GABM_D_DIMENSIONS) + 1, 0, 0>, gabm::real_t>;

#elif GABM_CHECK_MODEL(MinkowskiModel)

using algebra_t = algebra<metric<(GABM_D_DIMENSIONS) + 1, 1, 0>, gabm::real_t>;
